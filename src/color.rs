...
impl Color {
	...
	pub fn invert(&self) -> Self {
		Self::new(1.0 - self.red, 1.0 - self.green, 1.0 - self.blue)
	}

	pub fn convert(&self, max_intensity: u8) -> (u8, u8, u8) {
		(self.conv_red(max_intensity), self.conv_blue(max_intensity), self.conv_green(max_intensity))
	}
